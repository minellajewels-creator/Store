...
const FOOTER_HTML = `<footer class="site-footer">
  <div class="footer-container">
    <div class="footer-col brand-col">
      <h3 style="font-family:'Playfair Display',serif; font-size:1.5rem; color:var(--plum); margin-bottom:10px;">Minella Jewels</h3>
      <p style="font-size:13px; color:var(--text)">Everyday elegance with anti-tarnish, water-resistant jewelry designed for the modern woman.</p>
